...
require "resque_jobs/fetch_svn_commits"
...
Clockwork.handler do |job_name|
  ...
  when "fetch_svn_commits"
    Resque.enqueue(FetchSvnCommits) if queue_empty?("fetch_svn_commits")
...
Clockwork.every(55.seconds, "fetch_svn_commits")
